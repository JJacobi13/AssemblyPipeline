...
organism_type=$orgType #eukaryotic or prokaryotic. Default is eukaryotic
...
#-----Gene Prediction
snaphmm=$snapHmm #SNAP HMM file
gmhmm= #GeneMark HMM file
augustus_species=$augustusSpecies #Augustus gene prediction species model
